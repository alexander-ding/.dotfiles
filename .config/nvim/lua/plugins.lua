...
packer.startup {
  function(use)
    ...
    use { "olimorris/onedarkpro.nvim", config = [[require('config.onedarkpro')]]}
    ...
    use { "gelguy/wilder.nvim", cond = firenvim_not_active, opt = true, setup = [[vim.cmd('packadd wilder.nvim')]] }
    ...
    use { "xiyaowong/nvim-transparent", event = "VimEnter", config = [[require('config.nvim-transparent')]]}
  end,
  config = {
    max_jobs = 16,
